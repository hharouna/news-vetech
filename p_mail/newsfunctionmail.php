...
function cssmail($contenumail,$pmail,$pform,$psujet,$ptitle,$piedpage, $pdonnearray, $commentmail){
	...
	$title: title du documents ENCOR MERCI POUR LA SUITE DES EVEMENT ENCORS CMOI
	$piedpage: contenu pied de page MAIL DEVANT  LES AUTRES
