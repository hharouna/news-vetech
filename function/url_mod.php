...
public function connect_all($_token,$_session_info){ 
	$f_connet_client = '<form id="form-inline" class=" form-inline">

  <div class="container zone_connex shadow p-3 mb-3 mt-4 bg-light rounded ">
   

    		<div class="input-group mb-2  champs_email">
            ...
            <div class="input-group champs_mdp mb-2">
    			<div class="input-group-prepend">
    		...
    		<div class="form-check form-group text-center champs_check">
    			<input class="form-check-input form-group" type="checkbox" title="Sauvegarde mon mot de passe" id="inlineFormCheck">
    		</div>
       
        <div class="button_connex">
        ...
        <div class="button_inscription ">
			<a href="?url=inscription" class="mb-2 p-1 btn btn-block btn-primary"> Inscription </a>
        </div>

		<div class="alert-connect zone_alert"> </div>
