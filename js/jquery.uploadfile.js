...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            fileCounterStyle: " <i class='fas fa-caret-right'> </i> ",
            showFileSize: true,
            showProgress: false,
            nestedForms: true,
            showDownload: false,
            ...
            abortButtonClass: "btn btn-warning",
            cancelButtonClass: "btn btn-warning",
            dragDropContainerClass: "card border ",
            dragDropHoverClass: "state-hover",
            errorClass: " shadow-sm m-2 p-2 text-center alert alert-warning text text-danger",
            uploadButtonClass: "btn btn-primary",
            dragDropStr: "<span class='text text-center p-2'> <h4>Glisser votre image ICI </h4></span>",
            uploadStr:"<i class='fas fa-upload fa-3x'> </i>",
            abortStr: "<i class='fas fa-stop-circle fa-2x'> </i> ",
            cancelStr: "<i class='fas fa-stop-circle fa-2x'> </i> ",
            deleteStr: "<i class='fas fa-trash-alt fa-2x'> </i> ",
            doneStr: "<i class='fas fa-thumbs-up fa-2x'> </i> Fin",
            ...
            downloadStr: "<i class='fas fa-download fa-2x'> </i> ",
            customErrorKeyStr: "shadow-sm m-2 p-2 text-center alert alert-warning text text-danger",
            showQueueDiv: false,
            statusBarWidth: 100,
            dragdropWidth: 100,
            showPreview: false,
            ...
            if($.fn.ajaxForm) {
                ...
                $(obj).append(obj.errorLog);
   				...
   				if(s.showQueueDiv)
		            ...
		            obj.container = $("<div class=' card-columns shadow-sm m-2 p-2 bg-dark rounded'></div>").insertAfter($(obj)).width('auto');
	...
	this.enqueueFile = function(file){
        ...
        this.createProgress = function (filename,filepath,filesize) {
            ...
            if(s.showFileSize)
				fileNameStr += " <i class='fas fa-image'> </i> :"+getSizeStr(filesize)+"";
		...
		function defaultProgressBar(obj,s)
		{
			...
			this.statusbar = $("<div class='card p-2'></div>");
            this.preview = $(" <img class='card-img-top rounded border ' />").width('100%').height('100%').appendTo(this.statusbar).hide();
            this.filename = $("<div class='card-title text-light rounded border p-1 bg-secondary '></div>").appendTo(this.statusbar);
            this.progressDiv = $("<div class='progress'>").appendTo(this.statusbar).hide();
            this.progressbar = $("<div class='progress-bar progress-bar-striped'></div>").appendTo(this.progressDiv);
            this.abort = $("<button type='button'>" + s.abortStr + "</button>").appendTo(this.statusbar).hide();
            this.cancel = $("<button type='button'>" + s.cancelStr + "</button>").appendTo(this.statusbar).hide();
            this.done = $("<button type='button'>" + s.doneStr + "</button>").appendTo(this.statusbar).hide();
            this.download = $("<button type='button'>" + s.downloadStr + "</button>").appendTo(this.statusbar).hide();
            this.del = $("<button type='button'>" + s.deleteStr + "</button>").appendTo(this.statusbar).hide();

            this.abort.addClass("btn btn-danger btn-sm m-1");
            this.done.addClass("btn btn-success btn-sm m-1");
			this.download.addClass("btn btn-success btn-sm m-1");
            this.cancel.addClass("btn btn-danger btn-sm m-1");
            this.del.addClass("btn btn-danger btn-sm m-1");
