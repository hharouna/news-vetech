...
class f_af extends url {
	...
	$_formuaire_part ='<div class=" shadow-sm bg-dark  p-3 mb-3 rounded" > 
	<div class="row"> 
	<div class="col-sm-6  mb-3">
	<div class="card  p-3">
    ...
    public  function page($db,$_array_db,$_exploide,$_session_value,$token){
		...
		elseif($count_exploide<10):  
		 $Erreur =  "<div class='shadow-sm p-3 mb-3 bg-warning rounded  text text-center '><h3>Problème de connexion à cette page merci de ressayer !!!</h3> </div>"; 
		 return $Erreur;
